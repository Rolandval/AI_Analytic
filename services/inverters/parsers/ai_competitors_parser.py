...
- `name`: назва моделі інвертора (якщо не знайдено — просто поверни бренд)
- `full_name`: повна назва або опис інвертора
- `price`: ціна за 1 шт у доларах. Якщо валюта інша — конвертуй у $ (якщо можливо). Якщо не знайдено — 0
