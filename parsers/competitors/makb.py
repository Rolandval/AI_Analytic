...
def get_page_url(page: int) -> str:
    if page == 1:
        return "https://makb.com.ua/akkumuliatory-legkovye"
    page_num = (page - 1) * 24
    return f"https://makb.com.ua/akkumuliatory-legkovye?per_page={page_num}"
...
async def get_last_page() -> int:
    ...
    async with aiohttp.ClientSession(headers=headers) as session:
        url = "https://makb.com.ua/akkumuliatory-legkovye"
