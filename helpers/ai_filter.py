...
- якщо пускови струм 0, то глянь в full_name зазвикай він там вказується числом перед EN або A, якщо і цього немає тоді залиш 0
...
def ai_filter(data: list):
    ...
    print(f"Початок фільтрації {total_items} акумуляторів")
    ...
    print(f"✅ Фільтрацію завершено. Знайдено {len(parsed_results)} акумуляторів")
