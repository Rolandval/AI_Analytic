...
from services.batteries.parsers.competitors_head import parse_ai_reports as parse_ai_reports_competitors
from services.batteries.parsers.ai_txt_head import parse_ai_reports as parse_ai_reports_ai_txt
