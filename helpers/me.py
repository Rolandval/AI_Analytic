...
async def get_or_create_me(session: AsyncSession, suplier_name: str) -> int:
    ...
    new_suplier = Suppliers(name=suplier_name_upper, is_me=True, is_supplier=False, is_competitor=False)
